...
export default function AgentSidebar() {
  ...
  return (
    <div className="relative bg-secondary h-screen rounded-md flex flex-col  items-center">
      ...
      <div className="flex items-center justify-center gap-3 w-full mx-2">
        <div className=" flex items-center justify-between  bg-[#2e2e2e]/25 mt-3 mr-3 rounded-md h-10 w-[90%]">
          <button
